                ...
                <div class="col-md-12">
                  <div class="card">
                      <div class="container my-5">
                          <form action="database/registrasi.php" method="post" enctype="multipart/form-data">
                          <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <input type="password" class="form-control" id="inputPassword4" name="password" pplaceholder="Password" required>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputAddress">Nama Lengkap</label>
                            <input type="text" class="form-control" id="inputAddress" placeholder="Nama Lengkap" name="nama" required>
                          </div>
                          <div class="form-group">
                            <label for="inputAddress2">Alamat Lengkap</label>
                            <input type="text" class="form-control" id="inputAddress2" placeholder="Alamat Lengkap" name="alamat" required>
                          </div>
                          <div class="form-group">
                            <label for="notelpon">Nomor Telepon</label>
                            <input type="text" class="form-control" id="notelpon" placeholder="Nomor Telepon" name="notelp" required>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="file" class="form-control" id="fotoktp" placeholder="Nomor KTP" name="gambar" required>
                          </div>
                          <button type="submit" class="btn filled-button btn-lg btn-danger text-white">Registrasi</button>
                        </form>
                      </div>
