...
session_start();
if(isset($_SESSION["status"]) && isset($_GET['id'])){
$id=$_GET['id'];
$id_user = $_SESSION['id'];
}
else
                  ...
                  <div class="card">
                      <div class="container my-5">
                        <div class="row">
                          ...
                          <form action="bayar.php?id_mobil=<?=$id?>" method="post">
                          <div class="form-row">
                            <div class="form-group col-md-6">
                              <label for="inputEmail4">Tanggal Penyewaan</label>
                              <input type="date" class="form-control" id="inputEmail4" name="tgl_ambil" placeholder="Email" required min="<?=date('d/m/Y')?>">
                            </div>
                            <div class="form-group col-md-6">
                              <label for="inputPassword4">Tanggal Pengembalian</label>
                              <input type="date" class="form-control" id="inputPassword4" name="tgl_kembali" placeholder="Password" min="<?=date('d/m/Y')?>" required>
                            </div>
                          </div>
                          <button type="submit" class="btn filled-button btn-lg btn-danger text-white">Pembayaran</button>
                        </form>
                      </div>
